#ifndef WAITSETDATADCPS_IMPL_H_
#define WAITSETDATADCPS_IMPL_H_
...
namespace Messenger {
    ...
    class OS_EXAMPLE_API MessageTypeSupportMetaHolder : public ::DDS::OpenSplice::TypeSupportMetaHolder
    {
    public:
    ...
    class OS_EXAMPLE_API MessageTypeSupport : public virtual MessageTypeSupportInterface,
    ...
    private:
        ...
        MessageTypeSupport & operator= (const MessageTypeSupport &);
    };
    ...
    class OS_EXAMPLE_API MessageDataWriter_impl : public virtual MessageDataWriter,
    ...
    private:
        ...
        MessageDataWriter_impl & operator= (const MessageDataWriter_impl &);
    };
    
    class OS_EXAMPLE_API MessageDataReader_impl : public virtual MessageDataReader,
    ...
    private:
        MessageDataReader_impl (const MessageDataReader_impl &);
        MessageDataReader_impl & operator= (const MessageDataReader_impl &);
    ...
    class OS_EXAMPLE_API MessageDataReaderView_impl : public virtual MessageDataReaderView,
    ...
    private:
        MessageDataReaderView_impl (const MessageDataReaderView_impl &);
    
        MessageDataReaderView_impl & operator= (const MessageDataReaderView_impl &);
    };
